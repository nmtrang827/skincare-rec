export const CONCERN_TO_INGREDIENTS = {
  Acne_Severity: ["salicylic acid", "benzoyl peroxide", "niacinamide", "azelaic acid", "sulfur", "zinc"],
  Dryness_Severity: ["hyaluronic acid", "glycerin", "ceramide", "squalane", "panthenol"],
  ...
  Sensitivity_Severity: ["allantoin", "centella asiatica", "green tea", "chamomile", "colloidal oatmeal", "aloe vera"],
};